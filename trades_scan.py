                    ...
                    if deb > 0:
                        trades.append({
                            ...
                            "thesis": f"targets the projected {hp['date']} rebound high. "
                                      f"DO NOT enter on the date alone — wait for the low to "
                                      f"CONFIRM: price back above ${spot*1.03:,.0f} (+3% off "
                                      f"the low). Bounce bets in a falling tape are lottery "
                                      f"tickets (graded lesson from 7/23-24)",
                            "exp": e2s, "strikes": [kb, kt], "premium": round(deb, 2),
                            "execute": (entry_win or "") + " — AFTER +3% reversal confirms",
                            "exitWin": exit_win})
